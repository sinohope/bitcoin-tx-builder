...
func CalcWitnessSignatureHashRaw(subScript []byte, sigHashes *TxSigHashes,
	...
	return calcWitnessSignatureHashRaw(subScript, sigHashes, hashType, tx, idx, amt)
}
...
func CalcTaprootSignatureHashRaw(sigHashes *TxSigHashes, hType SigHashType,
	...
	return calcTaprootSignatureHashRaw(sigHashes, hType, tx, idx, prevOutFetcher, sigHashOpts...)
}
